...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        //     });
        // } else {
        //     // *scores.get_mut(team_1_name.to_string()).unwrap() += 10;
        //     *scores.get_mut(&team_1_name).unwrap()//.goals_scored += team_1_score;
        //     // *scores.get_mut(team_1_name.to_string()).unwrap().goals_conceded += team_2_score;
        // }
        ...
        scores.entry(String::from(String::from(&team_2_name)))
        .and_modify(|t| {
